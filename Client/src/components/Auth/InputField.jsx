    ...
    <>
      <div className="flex flex-col">
        ...
        <input
          ...
          } bg-gray-700 text-white placeholder-gray-400 hover:border-cyan-400 focus:border-blue-500 rounded-md p-2 sm:p-2 text-sm sm:text-base transition-all duration-200 outline-none`}
          type={props.type}
          step={props.step || "any"}
